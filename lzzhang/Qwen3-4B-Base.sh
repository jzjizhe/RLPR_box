...
layer=29
TOTAL_STEPS=300
EXP_NAME=Qwen3-4B_rlhr_cot_answer_topk_norm_clip01_box_layer${layer}
...
python -m verl.trainer.main_ppo \
    ...
    +actor_rollout_ref.actor.reward_hidden_type=subspace_energy_overlap_topk_norm \
