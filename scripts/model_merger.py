...
if __name__ == '__main__':
    ...
    parser.add_argument('--target_dir', required=True, type = str, help="The path for your target model")
    ...
    print(f"Move files from {os.path.join(local_dir, 'huggingface')} to {hf_path}")
    shutil.copytree(os.path.join(local_dir, 'huggingface'), hf_path, dirs_exist_ok=True)
    ...
    _ = auto_model.from_config(config, torch_dtype=torch.bfloat16)
