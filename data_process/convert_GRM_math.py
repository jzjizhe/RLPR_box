...
if __name__ == "__main__":
    ...
    parser.add_argument("--save_path", default="/data0/jzzhang/datasets/GRM/Math-500_Avg2.parquet")
    ...
    train_dataset = pd.read_parquet("/data0/jzzhang/datasets/RLPR/WebInstruct/Math-500_Avg2.parquet")
    ...
    def make_map_fn(split):
        def process_fn(row):
            ...
            return data
        return process_fn
    processed_data = train_dataset.apply(make_map_fn("test"), axis=1).tolist()
